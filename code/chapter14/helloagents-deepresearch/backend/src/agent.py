...
class DeepResearchAgent:
    ...
    def run_stream(self, topic: str) -> Iterator[dict[str, Any]]:
        ...
        yield {"type": "status", "message": "Инициализировать процесс исследования"}
    ...
    def _execute_task(
        ...
        *,
        ...
        task.summary = summary_text.strip() if summary_text else "Информации пока нет"
    ...
    def _persist_final_report(self, state: SummaryState, report: str) -> dict[str, Any] | None:
        ...
        note_title = f"Отчет об исследовании: {state.research_topic}".strip() or "исследовательский отчет"
    ...
    def _find_existing_report_note_id(self, state: SummaryState) -> str | None:
        ...
        for event in reversed(self._tool_tracker.as_dicts()):
            ...
            if note_type != "conclusion":
                ...
                if not (isinstance(title, str) and title.startswith("исследовательский отчет")):
                    continue
