...
class SummarizationService:
    ...
    def summarize_task(self, state: SummaryState, task: TodoItem, context: str) -> str:
        ...
        return summary_text or "Информации пока нет"
    ...
    def _build_prompt(self, state: SummaryState, task: TodoItem, context: str) -> str:
        ...
        return (
            ...
            "Синхронизируйте заметки в соответствии с вышеуказанными требованиями к совместной работе, а затем верните пользователю сводку Markdown (по-прежнему следуя шаблону сводки задачи)."
        )
