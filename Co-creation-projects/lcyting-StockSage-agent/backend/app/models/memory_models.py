"""
Модель данных системы памяти — снимок информационной панели за один день (индекс/пользовательская/горячая информация)
"""
...
"""Снимок данных информационной панели за один день"""
