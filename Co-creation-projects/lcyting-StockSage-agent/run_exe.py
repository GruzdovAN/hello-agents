...
Как использовать:
# Режим разработки (не упакованный)
    python run_exe.py

# PyInstaller После упаковки
    stock_analyzer.exe
...
Исправление пути #PyInstaller после упаковки
if getattr(sys, 'frozen', False):
# _MEIPASS — это временный каталог распаковки PyInstaller.
...
if __name__ == "__main__":
    ...
    print(f"============================================")
print(f"Интеллектуальный помощник по анализу акций")
печать(ф" версия: 0.1.0")
    print(f"  模式: {'exe 独立运行' if IS_FROZEN else '开发模式'}")
    print(f"============================================")
# Подсказка консоли: адрес прослушивания может быть 0.0.0.0, а локальный браузер использует 127.0.0.1.
    _ui_host = "127.0.0.1"
