...
Это более простой мультиагентный режим, чем протокол A2A.
"""
...
class AgentTool(Tool):
    """Оборачивает SimpleAgent в инструмент, вызываемый другими агентами"""
    ...
    def run(self, parameters: Dict[str, Any]) -> str:
        """Выполняет инструмент — прямой вызов обёрнутого agent"""
        ...
        try:
            # Прямой вызов метода run агента
