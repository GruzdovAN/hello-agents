...
Это **русский перевод** оригинального курса Datawhale: [github.com/datawhalechina/hello-agents](https://github.com/datawhalechina/hello-agents). Что переведено, а что нет — в [`RU_LOCALIZATION.md`](./RU_LOCALIZATION.md).
